...
RSpec.describe Dog, type: :model, dog: true do
  ...
  describe '#unlikeable_by?' do
    ...
    it 'should be defined' do
      expect(described_object).to respond_to :unlikeable_by?
    end
    ...
    context 'when is a free dog' do
      ...
      context 'when it has not been liked yet' do
        it 'should return false when any user is given' do
          expect(described_object.unlikeable_by?(current_user)).to be_falsey
          expect(described_object.unlikeable_by?(other_user)).to be_falsey
        end
      end
      ...
      context 'when it has been already liked' do
        ...
        it 'should return true when is given the user that already liked it' do
          expect(described_object.unlikeable_by?(current_user)).to be_truthy
        end

        it 'should false true when is given a user that did not liked it' do
          expect(described_object.unlikeable_by?(other_user)).to be_falsey
        end
      end
    end
    ...
    context 'when is not a free dog' do
      context 'when it has not been liked yet' do
        ...
        it 'should return false when its owner is given' do
          expect(described_object.unlikeable_by?(current_user)).to be_falsey # its owner can not like nor dislike
        end
      ...
      context 'when it has been already liked' do
        ...
        it 'should return true when is given the user that liked it' do
          expect(described_object.unlikeable_by?(current_user)).to be_truthy
        end
